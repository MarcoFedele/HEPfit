...
public:
    ...
    WilsonTemplateNew(unsigned int size_i, schemes scheme_i, orders_qcd order_qcd_i,
    ...
    const T& getWilson(orders_qcd order_qcd_i, orders_qed order_qed_i = QED0) const {
