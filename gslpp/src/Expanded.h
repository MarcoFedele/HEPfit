...
//template<class T> std::ostream& operator<< (std::ostream& output, const Expanded<T> x);

/***************** Begin UnExpanded * Expanded *****************/

// scalar * X -> commute
template <class T>    Expanded<T> operator*(const double& ue, const Expanded<T>& ex);
