...
EvolDB1bsg::EvolDB1bsg(unsigned int dim_i, schemes scheme, orders_qcd order, const StandardModel& model) 
...
gslpp::matrix<double> EvolDB1bsg::AnomalousDimension_M(orders_qcd order, unsigned int n_u, unsigned int n_d) const
{
...
gslpp::matrix<double> EvolDB1bsg::ToRescaleBasis(orders_qcd order, unsigned int n_u, unsigned int n_d) const
{
...
gslpp::matrix<double>& EvolDB1bsg::Df1Evolbsg(double mu, double M, orders_qcd order, schemes scheme) 
{
