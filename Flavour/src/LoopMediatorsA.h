...
#ifndef LOOPMEDIATORSA_H
#define LOOPMEDIATORSA_H
 ...
 */
class LoopMediatorsA: public StandardModel {
public:

    static const int NLoopMediatorsAvars = 15;

    static const std::string LoopMediatorsAvars[NLoopMediatorsAvars];
    ...
    virtual LoopMediatorsAMatching& getMatching() const
    {
        return LoopMediatorsAM.getObj();
    }
...
protected:
    ...
    mutable Matching<LoopMediatorsAMatching,LoopMediatorsA> LoopMediatorsAM;
...
class Deltaamu_LMA : public ThObservable {
public:
    /**
     * @brief Constructor.
     */
   Deltaamu_LMA(const StandardModel& SM_i);
...
class C9mC10_LMA : public ThObservable {
public:
    /**
     * @brief Constructor.
     */
...
class mpsi_mphiQ : public ThObservable {
public:
    /**
     * @brief Constructor.
     */
   mpsi_mphiQ(const StandardModel& SM_i);
...
class mpsi_mphiL : public ThObservable {
public:
    /**
     * @brief Constructor.
     */
   mpsi_mphiL(const StandardModel& SM_i);
...
class mphiQ_mphiL : public ThObservable {
public:
    /**
     * @brief Constructor.
     */
   mphiQ_mphiL(const StandardModel& SM_i);
